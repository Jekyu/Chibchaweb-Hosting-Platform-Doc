...
\fancyfoot[L]{Manual de usuario ChibchaWeb: Clientes y distribuidores - 2025}
\fancyfoot[C]{}
...
\input{roles/roles.tex}

\newpage
\section{Guía paso a paso por módulo}
\input{guiamodulo/guiamodulo.tex}

\newpage
\section{Casos de uso frecuentes}
\input{casosuso/casosuso.tex}

\newpage
\section{Recomendaciones y buenas prácticas}
\input{recomendaciones/recomendaciones.tex}

\newpage
\section{Preguntas frecuentes (FAQ)}
\input{preguntas/preguntas.tex}
